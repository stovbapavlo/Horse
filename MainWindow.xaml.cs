...
namespace Game
{
    public partial class MainWindow : Window
    {
        ...
        public MainWindow()
        {
            _horses = new Horse[5] 
            { 
                new Horse("Саньок", Brushes.Red), 
                new Horse("Олег", Brushes.Green), 
                new Horse("Вiтя", Brushes.Yellow), 
                new Horse("Alehandro", Brushes.Blue),
                new Horse("Микола", Brushes.Firebrick)
            };
        ...
        {
            path = $@"D:\ООП\2 семестр\Game\{path}\{name}";
